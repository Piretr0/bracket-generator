const teams = [
  { id: 1, nazwaZespolu: "Team A", users: [{ id: 1, imie: "Jan", nazwisko: "Kowalski", rezerwa: 0 }] },
  { id: 2, nazwaZespolu: "Team B", users: [{ id: 2, imie: "Anna", nazwisko: "Nowak", rezerwa: 0 }] },
  { id: 3, nazwaZespolu: "Team C", users: [{ id: 3, imie: "Piotr", nazwisko: "Zieliński", rezerwa: 0 }] },
  { id: 4, nazwaZespolu: "Team D", users: [{ id: 4, imie: "Kasia", nazwisko: "Wiśniewska", rezerwa: 0 }] },
  { id: 5, nazwaZespolu: "Team E", users: [{ id: 5, imie: "Marek", nazwisko: "Lewandowski", rezerwa: 0 }] },
